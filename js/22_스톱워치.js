...
const recordBth = document.querySelector("#recordBth");
...
//-----------------------------------------------------------------
/* START 버튼 클릭 시 10ms 마다 count 1증가 + 화면 시간 변경 */
startBtn.addEventListener("click", () => {
  ...
  if(startBtn.innerText === "PAUSE"){
    ...
    // 일시 정지 상태가 유지 되어야 하기 떄문에
    // 이벤트 핸들러를 여기서 종료 시켜
    // 아래 setInterval()을 수행 못하게
    return; 
...
function output(){
  ...
  // -> 1초증가
  if(second != timeList[2].innerText){
