...
function check1() {
  ...
  //input1.value : input 요소에 입력된 값 (string)
...
function check5() {
  ...
  // A와 B중 하나라도 입력된지 않으면 -> 입력되지 않은 값이 존재합니다
  if (a.value.length === 0 || b.value.leagth === 0) {
    alert("입려되지 않은 값이 존재합니다");
...
function check6(){
  ...
  const check6 = document.getElementById("input6");
